...
class ProviderDatabaseHelper {
  ...
  static const String _table = 'providers';

  static final ProviderDatabaseHelper instance =
  ProviderDatabaseHelper._internal();
  static Database? _database;

  ProviderDatabaseHelper._internal();

  factory ProviderDatabaseHelper() => instance;
